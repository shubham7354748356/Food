    ...
    <%
        if(rp!=null)
        {
            ...
            else
            {
                ...
                sb.append(" <div class='container  d-flex justify-content-center mt-3'><div class='row  justify-content-center col-lg-12'>");
                for(DishPojo dp : al)
                {
                    ...
                    sb.append("<div class='card-text'><div class='des'>"+dp.getDescription()+"</div><div class='mt-3 text-primary price'>Price :"+dp.getPrice()+"</div></div></div></div></div>");
