...
<body>
    <div class="container mt-5">
        ...
        <div class="row  d-flex justify-content-center  mt-5 pt-3">
            ...
            <a href="AdminDeleteUser.jsp?type=Supplier">   
                 <img src="verify1.jpeg" class="col-lg-12 ">
                    <h2 class="caption text-center bg-dark text-warning">Delete Supplier</h2>
               
            </a>
                 </div>
              <div class="col-lg-5 mt-5">
            <a href="AdminDeleteUser.jsp?type=Customer">
          <img src="delete.jpg" class="col-lg-12 ">
                <h2 class="caption text-center text-warning bg-dark">Delete Customer</h2>
